...
bool CMutexEvent::WaitEventTime(unsigned int wait_ms)
{
#ifdef WIN32
   UnLock();
...
bool CSectionEvent::WaitEventTime(unsigned int wait_ms)
{
#ifdef WIN32
   UnLock();
   DWORD ret = WaitForSingleObject(m_event, wait_ms);
